...
const Launch = ({ onSearch }) => {
    const [query, setQuery] = useState("");

    const handleSearch = () => {
        if (!query.trim()) return;

        // App'teki onSearch'i tetikle
        onSearch(query.trim());
            ...
            <div className="relative isolate px-6 lg:px-8">
                <div className="mx-auto max-w-2xl pt-32 pb-32 sm:py-48 lg:pt-48 lg:pb-40">
                    <div className="text-center">
                        <h1 className="text-balance text-5xl font-semibold tracking-tight text-brand sm:text-7xl">
                            Tarzına göre seç!
                        </h1>
                        <p className="mt-5 text-pretty text-base font-medium text-gray-400 sm:text-lg/7">
                            Binlerce giyim markası ve ürün arasından sana en uygun olanı keşfet.
                        </p>
