...
import TarzlaLogo from '../assets/svgs/tarzla.svg'
              ...
              <div className="border-b border-gray-200">
                <TabList className="-mb-px flex space-x-8 px-4">
                  {navigation.categories.map((category) => (
                    <Tab
                      key={category.name}
                      className="flex-1 whitespace-nowrap border-transparent bg-white px-1 py-4 text-base font-medium text-brand"
                    >
                      {category.name}
                    </Tab>
                  ))}
        ...
        <nav aria-label="Top" className="mx-auto px-4 sm:px-6 lg:px-8">
          <div className="border-b border-gray-200">
            <div className="flex h-16 items-center justify-between">
              ...
              {/* Logo */}
              <div className="flex sm:ml-0 ml-auto sm:pr-0 pr-4">
                <a href="#">
                  <span className="sr-only">Tarzla</span>
                  <img
                    alt=""
                    src={TarzlaLogo}
              ...
              <div className="flex items-center lg:w-[175px]">
